...
root = Tk() 
root.title("TIC TAC TOE for Shreya")
...
def tictac(buttons):
	...
	if buttons["text"] == " " and click == True:
		...
		tkinter.messagebox.showinfo("Winner is Richa ", "Richa have just won a game")
		...
		tkinter.messagebox.showinfo("Winner is Shreya ", "Shreya have just won a game")
